...
osThreadId StratchassistasHandle;
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of Stratchassistas */
  osThreadDef(Stratchassistas, Chassis_Task, osPriorityRealtime, 0, 256);
  StratchassistasHandle = osThreadCreate(osThread(Stratchassistas), NULL);
...
/**
* @brief Function implementing the Stratchassistas thread.
* @param argument: Not used
* @retval None
*/
