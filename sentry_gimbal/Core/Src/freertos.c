...
osThreadId StartSerialtaskHandle;
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of StartSerialtask */
  osThreadDef(StartSerialtask, Serial_Task, osPriorityRealtime, 0, 256);
  StartSerialtaskHandle = osThreadCreate(osThread(StartSerialtask), NULL);
...
/**
* @brief Function implementing the StartSerialtask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Serial_Task */
__weak void Serial_Task(void const * argument)
{
